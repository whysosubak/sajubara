...
import { ELEMENT_LABEL_KR, BRANCH_LABEL_KR, ELEMENT_EMOJI } from "@/lib/bara/types";
      ...
      <section className="px-4 pt-1 pb-4">
        ...
        >
          <p className="text-[13px] text-sb-ink-2 leading-relaxed mb-3">
            아직 받은 바라 카드가 없어요. 사주바라부터 시작해볼까요?
          </p>
          <Link
            href="/saju"
    ...
    <section className="px-4 pt-1 pb-4">
      ...
      >
        <div className="flex items-center gap-3">
          ...
          <span className="text-[12px] font-semibold text-sb-ink-3 shrink-0">결과 다시 보기 ›</span>
        </div>
      </Link>
    </section>
  );
